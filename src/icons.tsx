...
// 📂 プロジェクトを開くアイコン（MojiQ準拠: ファイル＋上向き矢印）
export function OpenProjectIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// 紙に斜線アイコン（ページなし）
export function NoPageIcon({ size = 48, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// 右綴じアイコン
export function BindingRightIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// 左綴じアイコン
export function BindingLeftIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// チェックアイコン
export function CheckIcon2({ size = 14, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
// ⇄ サイドバー反転アイコン
export function FlipIcon({ size = 16, className, isFlipped }: IconProps & { isFlipped?: boolean }) {
  return (
    <svg
      width={size}
      height={size}
...
export function ScissorsIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
